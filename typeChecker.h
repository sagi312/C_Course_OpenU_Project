...
int isExtern(TokenLine* tokens, int labelFlag, Table* codeSymbolTable, Table* dataSymbolTable);
int isEntry(TokenLine* tokens, int labelFlag, Table* codeSymbolTable, Table* dataSymbolTable);
